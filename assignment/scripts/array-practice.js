...
let favoriteFoods = ['pizza', 'french toast', 'biscuits and gravy', 'strawberries'];
...
console.log('Added my other, other favorite food to end', favoriteFoods);
...
console.log('Removed last food... sad day', removedFood);
...
favoriteFoods [1] = 'chocolate chip cookies';
console.log('My new list has changed to', favoriteFoods);
